...
export function run () {
    console.log('Move Zeros:', moveZeroes([0,1,0,3,12])); // [ 1, 3, 12, 0, 0 ]
    console.log('-----------------------------------');
    console.log('Move Zeros:', moveZeroes([1,0,2,0,3,12])); // [ 1, 2, 3, 12, 0, 0 ]
    console.log('-----------------------------------');
    console.log('Move Zeros:', moveZeroes([0])); // [0]
}
